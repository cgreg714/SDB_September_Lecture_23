...
one.name = 'sample';
// console.log(one);
// displays NewObject { name: 'sample' }
...
/* 
    1. Keyword - 'class' - to establish what type of "function".
    2. The name of our class. Should be Pascal Case.
    3. Keyword - 'constructor' - is automatically run when the class is instantiated (created/started).
    4. The parameters for our constructed object. Establish values of the new object.
    5. Keyword - 'this' - refers to "this" specific object being created.
    6. The name of the key to our new object.
    7. The value for those keys being created (set by parameters).
*/

let itemZero = new Item();
console.log(itemZero);  // returns an object with the set keys, but that hold undefined values.
//Item { name: undefined, description: undefined, price: undefined }

let itemOne = new Item('beans', 'canned', 0.89)
console.log(itemOne); // returns an obj with the set keys AND the declared values
// Item { name: 'beans', description: 'canned', price: 0.89 }
...
//console.log(dryGoods); returns DeptInventory { department: 'Dry Goods', items: [] }
...
/* 
    1. Establishing the name of the method. Should represent the action they are performing.
